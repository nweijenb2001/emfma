This folder contains the Python modules used in the EMFMA case study. Below is a description of each file:
...
load_data.py:
Loads background data required to run the plMFA model.

MFA_module.py:
Constructs the MFA module of the plMFA model.
